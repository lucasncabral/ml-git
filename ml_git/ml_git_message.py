...
output_messages = {
    ...
    'INFO_MISSING_DESCRIPTOR_FILES_DOWNLOAD': '%d missing descriptor files detected. Download:',
    ...
    'INFO_FINISH_INTEGRITY_CHECK': 'Finish integrity check on [%s]',
    ...
    'INFO_FIXING_CORRUPTED_FILES': 'Fixing {} corrupted files found in {} entity',
    'INFO_MISSING_BLOB_FILES_DOWNLOAD': '%d missing blob files detected. Download:',
